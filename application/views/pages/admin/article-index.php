...
<section class="content-header">
  <h1>
  Articles
  <small>Daftar Article Terpublikasikan.</small>
  </h1>
</section>
<!-- Main content -->
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover">
            ...
            <tr>
              ...
              <td>
                <a class="btn btn-success btn-sm" href="<?php echo site_url('admin/article/update/'.$row->id);?>"><i class="fa fa-pencil"></i> ubah</a> 
            ...
            ?>
            <tr>
              <td colspan="6" class="text-center">no data found. <a href="<?php echo site_url('admin/article/add');?>">add new</a></td>
            </tr>
            <?php
            endif;
            ?>
