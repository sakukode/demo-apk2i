...
<section class="content-header">
  <h1>
  New Gallery
  <small>Create new Gallery for visitor.</small>
  </h1>
</section>
<!-- Main content -->
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Form New Gallery</h3>
        </div>
        <!-- /.box-header -->
        <!-- Notif Error -->
        <div class="box-body">
        ...
        <!-- form start -->
        <?php echo form_open('admin/gallery/do_add', array('id' => 'form-gallery-add')); ?>
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" rows="3" placeholder="Maksimal 300 Karakter dengan Spasi ..." name="description"></textarea>
            </div>
            <div class="form-group">
