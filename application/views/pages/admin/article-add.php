...
<section class="content-header">
  <h1>
  New Article
  <small>Create new Article for visitor.</small>
  </h1>
</section>
<!-- Main content -->
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Form New Article</h3>
        </div>
        <!-- /.box-header -->
        ...
        <!-- form start -->
        <?php echo form_open('admin/article/do_add', array('id' => 'form-article-add')); ?>
          <div class="box-body">
            <div class="form-group">
              <label for="">Judul Article</label>
              <input type="text" class="form-control" id="" placeholder="Judul Article" name="name" />
            </div>
            <div class="form-group">
              <label>Cuplikan Article</label>
              <textarea class="form-control" rows="3" placeholder="Maksimal 200 Karakter dengan Spasi ..." name="description"></textarea>
            </div>          
            <div class="form-group">
