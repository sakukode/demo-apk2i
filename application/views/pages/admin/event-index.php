          ...
          <table class="table table-hover">
            ...
            <tr>
              ...
              <td>
                ...
                <span class="badge bg-green">Berjalan</span>                
                <?php else: ?>
                <span class="badge bg-red">Selesai</span>
                <?php endif; ?>
              </td>
              <td>
                <a class="btn btn-success btn-sm" href="<?php echo site_url('admin/event/update/'.$row->id);?>"><i class="fa fa-pencil"></i> ubah</a> 
            ...
            ?>
            <tr>
              <td colspan="6" class="text-center">no data found. <a href="<?php echo site_url('admin/event/add');?>">add new</a></td>
            </tr>
            <?php
            endif;
            ?>
