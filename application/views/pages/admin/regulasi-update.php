...
<section class="content-header">
  <h1>
  Update Regulasi
  <small>Update Regulasi for visitor.</small>
  </h1>
</section>
<!-- Main content -->
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Form Update Regulasi</h3>
        </div>
        <!-- /.box-header -->
        <!-- Notif Error -->
        <div class="box-body">
        ...
        <!-- Eof Notif Error -->
        <!-- form start -->
        <?php echo form_open('admin/regulasi/do_update', array('id'=> 'form-regulasi-update'));?>
          <div class="box-body">
            <input type="hidden" name="id" value="<?php echo $regulasi->id;?>" />
            <div class="form-group">
              <label for="">Nama Regulasi</label>
              <input type="text" class="form-control" id="" placeholder="Nama Regulasi" name="name" value="<?php echo $regulasi->name;?>">
            </div>
            <div class="form-group">
